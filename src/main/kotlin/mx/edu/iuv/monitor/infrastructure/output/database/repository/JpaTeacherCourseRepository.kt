...
import mx.edu.iuv.monitor.infrastructure.output.database.entity.TeacherWithCourseSummaryEntity
...
@Repository
interface JpaTeacherCourseRepository: JpaRepository<TeacherWithCourseSummaryEntity, Long> {

    @Query(nativeQuery = true, value = TeacherQuery.GET_ALL_TEACHERS_COURSE_INACTIVE_24_HOURS)
    fun runQueryGetAllTeachersCourseInactiveLast24Hours(): List<TeacherWithCourseSummaryEntity>

    @Query(nativeQuery = true, value = TeacherQuery.GET_ALL_TEACHERS_COURSE_MISSING_WELCOME_MESSAGE)
    fun runQueryGetAllTeachersCourseMissingWelcomeMessageLast24Hours(): List<TeacherWithCourseSummaryEntity>
